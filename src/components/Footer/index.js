...
const Footer = () => {
    return (
        ...
        <div>
            ...
            <p>@ 2021 CasaNova Design & Build. All rights reserved. Site designed and developed by Contra Fluxo</p>
        </div>
            <Link className="back-to-top-container" activeClass="active" to="home" spy={true} smooth={true} offset={-70} duration={600}>
